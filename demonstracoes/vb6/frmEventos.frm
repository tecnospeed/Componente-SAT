...
Begin VB.Form frmEventos 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "lblXmlManisfestacao"
      Tab(0).Control(1)=   "lblDataEvento"
      Tab(0).Control(2)=   "lblJustificativaManifestacao"
      Tab(0).Control(3)=   "lblTipoEvento"
      Tab(0).Control(4)=   "lblFusoManifestacao"
      Tab(0).Control(5)=   "lblCNPJDestinatario"
      Tab(0).Control(6)=   "lblChaveManifestacao"
      Tab(0).Control(7)=   "lblManifestacao"
      Tab(0).Control(8)=   "mmManifestacao"
      Tab(0).Control(9)=   "btnEnviarManifestacao"
      Tab(0).Control(10)=   "btnDataEvento"
      Tab(0).Control(11)=   "edtDataEvento"
      Tab(0).Control(12)=   "edtJustificativaManifestacao"
      Tab(0).Control(13)=   "cbTipoEvento"
      Tab(0).Control(14)=   "cbFusoManifestacao"
      Tab(0).Control(15)=   "edtCNPJManifestacao"
      Tab(0).Control(16)=   "edtChaveManifestacao"
      ...
      Tab(2).Control(1)=   "btnDownloadNFe"
      Tab(2).Control(2)=   "edtChaveDownload"
      Tab(2).Control(3)=   "lblXmlDownload"
      Tab(2).Control(4)=   "lblChaveDownload"
      Tab(2).Control(5)=   "lblDownloadNFe"
